    ...
    <div className="location">
      ...
      <div className="drive-thru">
        <h2 data-aos="fade-right">We are open for drive thru and curbside pickup!</h2>
          ...
          <h3 data-aos="fade-right">Order delivery with <a href="https://www.doordash.com/store/popo-pullman-637614">DoorDash</a>.</h3>
      </div>

      <div className="location-image"></div>

      <div className="inside-store">
        <h2 data-aos="fade-right">We can't wait to dine with you soon!</h2>
        <Row xs={3} md={1} lg={3} className="inside-store-row-container">
          <Col>
